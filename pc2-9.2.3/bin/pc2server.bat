...
rem $HeadURL: http://pc2.ecs.csus.edu/repos/pc2v9/branches/PC2_RELEASE_9_2_x/bin/pc2server.bat $
...
:end
rem eof pc2server.bat $Id: pc2server.bat 2460 2012-02-01 04:01:12Z boudreat $
