...
rem $HeadURL: http://pc2.ecs.csus.edu/repos/pc2v9/branches/PC2_RELEASE_9_2_x/bin/pc2admin.bat $
...
:end
rem eof pc2admin.bat $Id: pc2admin.bat 2023 2009-12-19 07:23:18Z boudreat $
